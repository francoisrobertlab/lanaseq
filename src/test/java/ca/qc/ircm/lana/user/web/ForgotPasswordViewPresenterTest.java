...
import static ca.qc.ircm.lana.user.web.ForgotPasswordView.SAVED;
...
import ca.qc.ircm.lana.user.ForgotPasswordService;
import ca.qc.ircm.lana.user.ForgotPasswordWebContext;
