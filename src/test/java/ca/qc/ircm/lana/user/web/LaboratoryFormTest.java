...
import static ca.qc.ircm.lana.user.web.LaboratoryForm.CLASS_NAME;
...
public class LaboratoryFormTest extends AbstractViewTestCase {
  private LaboratoryForm form;
  ...
  public void labels() {
    ...
    assertEquals(laboratoryResources.message(NAME), form.name.getLabel());
  }
  ...
  public void getLaboratory() {
    ...
    assertEquals(laboratory, form.getLaboratory());
  }
  ...
  public void setLaboratory() {
    ...
    assertEquals(laboratory.getName(), form.name.getValue());
  }
  ...
  @Test
  public void setLaboratory_Update() {
    Laboratory laboratory = laboratoryRepository.findById(1L).get();
  ...
  public void validate_NameEmpty() {
    ...
    BinderValidationStatus<Laboratory> status = form.validate();
