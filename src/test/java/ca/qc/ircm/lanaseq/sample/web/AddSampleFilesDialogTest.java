...
public class AddSampleFilesDialogTest extends AbstractKaribuTestCase {
  ...
  public void beforeTest() throws Throwable {
    ...
    files.add(temporaryFolder.newFile("sample_R1.fastq"));
    files.add(temporaryFolder.newFile("sample_R2.fastq"));
    files.add(temporaryFolder.newFile("sample.bw"));
    files.add(temporaryFolder.newFile("sample.png"));
    for (File file : files) {
