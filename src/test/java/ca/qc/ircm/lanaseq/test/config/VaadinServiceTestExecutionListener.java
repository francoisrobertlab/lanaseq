...
import static ca.qc.ircm.lanaseq.test.config.VaadinServiceTestComponent.request;
import static ca.qc.ircm.lanaseq.test.config.VaadinServiceTestComponent.response;
import static ca.qc.ircm.lanaseq.test.config.VaadinServiceTestComponent.service;
import static ca.qc.ircm.lanaseq.test.config.VaadinServiceTestComponent.session;
