 ...
 */
public class SeleniumSecurityFilter extends GenericFilterBean implements TestExecutionListener,
    Ordered {

  public static final String BEAN_NAME = "SeleniumSecurityFilter";
  private static final Logger logger = LoggerFactory.getLogger(SeleniumSecurityFilter.class);
  private static boolean copyAuthenticationOnFilter;
  private static Authentication authentication;
  private final SecurityContextRepository repo;

  public SeleniumSecurityFilter() {
    this(new HttpSessionSecurityContextRepository());
  }

  public SeleniumSecurityFilter(SecurityContextRepository repo) {
    this.repo = repo;
  }
  ...
  public void beforeTestMethod(TestContext testContext) {
    copyAuthenticationOnFilter = isSeleniumTest(testContext);
